...
console.log('Punto 1.1 ', character);
...
console.log('Punto 1.2 ', sentence);
...
console.log('Punto 1.3 ', sumPrice);
...
console.log('New Global Base Price: ' + globalBasePrice);
console.log('New Car 1 Final Price: ' + car1.finalPrice);
console.log('New Car 2 Final Price: ' + car2.finalPrice);
